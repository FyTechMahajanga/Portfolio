...
const Services = () => {
  ...
  const categories = [
    {
      title: t('services.categories.web'),
      services: [
        {
          icon: <Layout className="w-8 h-8" />,
          title: t('services.web.mockup.title', 'Web & App Mockup Design'),
          description: t('services.web.mockup.description', 'Design of professional mockups for your web and mobile projects.'),
          features: [
            t('services.web.mockup.features.wireframes', 'High-fidelity wireframes'),
            t('services.web.mockup.features.responsive', 'Responsive design'),
            t('services.web.mockup.features.prototypes', 'Interactive prototypes'),
            t('services.web.mockup.features.styleguide', 'Style guide')
          ],
          price: t('services.web.mockup.price', 'From 200,000 Ar')
        },
        {
